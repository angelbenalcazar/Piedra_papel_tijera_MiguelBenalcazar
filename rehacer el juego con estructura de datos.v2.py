...
modalidad_juego={'modalidad de juego': int(input("Jugador contra computadora, escribe: 1. Jugador_1 contra jugador_2, escribe: 2: ")), 'jugador': input("Coloca tu nombre: "),}


def new_func(modalidad_juego, jugador2):
...
if modalidad_juego['modalidad de juego']==1:
    ...
    while nuevo_juego=="si" or nuevo_juego=="SI" or nuevo_juego=="Si" or nuevo_juego=="s" or nuevo_juego=="S":
        ...
        while contador<3:
            ...
            if juego["seleccion_jugador"]!=1 and juego["seleccion_jugador"] !=2 and juego["seleccion_jugador"] !=3:
                print("elige un número entre el 1 al 3, tú pusiste ", juego["seleccion_jugador"])

            elif juego["seleccion_jugador"]==juego["seleccion_computadora"]:
                
                if juego["seleccion_jugador"]==1 and juego["seleccion_computadora"]==1:
                    print("Empate, los dos sacaron piedra")
                elif juego["seleccion_jugador"]==2 and juego["seleccion_computadora"]==2:
                    print("Empate, los dos sacaron papel")
                elif juego["seleccion_jugador"]==3 and juego["seleccion_computadora"]==3:
    ...
    while nuevo_juego=="si" or nuevo_juego=="SI" or nuevo_juego=="Si" or nuevo_juego=="s" or nuevo_juego=="S":
        ...
        while contador<3:
            ...
            while jugador1_2["seleccion_jugador1"] !=1 and jugador1_2["seleccion_jugador1"] !=2 and jugador1_2["seleccion_jugador1"] !=3:
                print("Jugador 1, elige un número entre el 1 al 3, tú pusiste ", jugador1_2["seleccion_jugador1"])
            ...
            while jugador1_2["seleccion_jugador2"] !=1 and jugador1_2["seleccion_jugador2"] !=2 and jugador1_2["seleccion_jugador2"] !=3:
                print("Jugador 2, elige un número entre el 1 al 3, tú pusiste ", jugador1_2["seleccion_jugador2"])
            ...
            if jugador1_2["seleccion_jugador1"]==jugador1_2["seleccion_jugador2"]:
                ...
                if jugador1_2["seleccion_jugador1"]==1 and jugador1_2["seleccion_jugador2"]==1:
                    print("Empate, los dos sacaron piedra")

                elif jugador1_2["seleccion_jugador1"]==2 and jugador1_2["seleccion_jugador2"]==2:
                    print("Empate, los dos sacaron papel")

                elif jugador1_2["seleccion_jugador1"]==3 and jugador1_2["seleccion_jugador2"]==3:
                    print("Empate, los dos sacaron tijera")
        ...
        new_func(modalidad_juego, jugador2)
